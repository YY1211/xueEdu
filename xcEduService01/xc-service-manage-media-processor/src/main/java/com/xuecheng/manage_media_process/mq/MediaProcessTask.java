...
public class MediaProcessTask {
    ...
    public void receiveProcessTask(String msg) {
        ...
        if (!fileType.equalsIgnoreCase("mp4")) {
            boolean istrue = mediaToMp4(mediaFile);
            if(!istrue){
                return ;
            }
            boolean isToM3u8 = Mp4Tom3u8(mediaFile, mediaId);
            if(!isToM3u8){
                return ;
            }
    ...
    private boolean mediaToMp4(MediaFile mediaFile){
        ...
        if (result == null || !result.equals("success")) {
            ...
            mediaFile.setFileStatus("303002");//处理成功
            mediaFileRepository.save(mediaFile);
            return true;
        }
    }
    ...
    private boolean Mp4Tom3u8(MediaFile mediaFile,String mediaId){
