...
public class TestProcessBuilder {
    ...
    public void testProcessMp4(){
        ...
        //video_path视频地址
        String video_path = videoLocation+"Uralesbian.mp4";
        //mp4_name mp4文件名称
        String mp4_name  ="Uralesbian.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path="D:/logs/video/mp4";
    ...
    @Test
    public void testProcessm3u8(){
        //ffmpeg的路径
        String ffmpeg_path = ffmpegPath;
        //video_path视频地址
        String video_path = videoLocation+"Uralesbian.mp4";

        String m3u8_name  ="Uralesbian.m3u8";
        String m3u8folder_path="D:/logs/video/hls/";
